...
<br />
      ...
      <div className="services">
        <div className="tip">
          ...
          <div className="serv-text">
            ...
            varius enim eros elementum tristique. Duis cursus, viverra ornare,
            eros dolor interdum nulla, commodo diam libero vitae
          </div>
        </div>
      ...
      <br />
      <br />
      <h1 className="sec-header">AWESOME TEAM</h1>
      ...
      <div className="staffs">
        <div className="staff">
          ...
          <div className="staff-name">Isaiah Psalm</div>
        ...
        <div className="staff">
          ...
          <div className="staff-name">Jeniah Ortega</div>
        ...
        <div className="staff">
          ...
          <div className="staff-name">Eugene Davis</div>
        ...
        <div className="staff">
          ...
          <div className="staff-name">Wayne Moore</div>
